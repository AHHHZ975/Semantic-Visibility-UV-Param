...
#include <ATen/ATen.h>
#include <ATen/cuda/CUDAApplyUtils.cuh>   // for at::cuda::getApplyGrid
#include <torch/extension.h>              // main C++ extensions API
#include <ATen/cuda/CUDAContext.h>        // at::cuda::getCurrentCUDAStream()


#define CHECK_EQ(a,b) \
  TORCH_CHECK((a)==(b), "CHECK_EQ failed: " #a "=", (a), " != " #b "=", (b))
#define TORCH_CHECK_NO_THROW(expr) \
  do { cudaError_t _err = (expr); (void)_err; } while(0)
...
at::Tensor ApproxMatchForward(
  ...
  TORCH_CHECK_NO_THROW(cudaGetLastError());
